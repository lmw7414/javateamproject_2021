...
public class DisplayButton extends JFrame 
{
  ...
  /* private JButton fancyJButton1; // button with icons
   ...
   public DisplayButton(int n)
   {
      ...
      picture[7] = new ImageIcon( getClass().getResource( "burger.png" ) );
      ...
      public void actionPerformed( ActionEvent event )
      {
    	  if(flippedCard == -1) { // first flip
    		  ...
    		  for (int i = 1 ; i<=size ; i++){
    			  ...
    			  if (cards[firstCard].getCardPicture() == cards[secondCard].getCardPicture()) { // if matched
    				  // add TTS
    				  matched = true;
